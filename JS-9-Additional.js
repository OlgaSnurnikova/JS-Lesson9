...
for (const user of usersList) {
    ...
    zip.innerText = user.address.zipcode;
    ...
    divWebsite = user.website;
    let divCompany = document.createElement('div');
    let companyKeys = Object.keys(user.company);
    for (const key of companyKeys) {
        let companyInfo = document.createElement('div');
        companyInfo.innerText = user.company[key];
        divCompany.appendChild(companyInfo);
    } // якщо у компанії будуть додаватися поля


    document.body.append(divId);
    document.body.append(divName);
    document.body.append(divUserName);
    document.body.append(divEmail);
    document.body.append(divAddress);
    document.body.append(divPhone);
    document.body.append(divWebsite);
    document.body.append(divCompany);
    divAddress.append(street);
    divAddress.append(suite);
    divAddress.append(zip);
    divAddress.append(geo);
    geo.append(lat);
    geo.append(lng);
}
